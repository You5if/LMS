...
export class SelectService {
  ...
  getDropdown2(IdColumn:string, TableName:string, DisplayColumn:string, Condition:string,  pNoneRequired: boolean = false, id1: number, id2: number): Observable<SelectModel[]> {
