...
import { SubTeOrderEntryService } from './subteorder-entry.service';

@Component({
  selector: 'app-subteorder-entry',
  templateUrl: './subteorder-entry.component.html',
  styleUrls: ['./subteorder-entry.component.scss']
})

export class SubTeOrderEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubTeOrderEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubTeOrderEntryComponent>,
