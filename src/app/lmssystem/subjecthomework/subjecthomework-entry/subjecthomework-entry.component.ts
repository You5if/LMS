...
import { SubjectHomeworkEntryService } from './subjecthomework-entry.service';

@Component({
  selector: 'app-subjecthomework-entry',
  templateUrl: './subjecthomework-entry.component.html',
  styleUrls: ['./subjecthomework-entry.component.scss']
})

export class SubjectHomeworkEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubjectHomeworkEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubjectHomeworkEntryComponent>,
