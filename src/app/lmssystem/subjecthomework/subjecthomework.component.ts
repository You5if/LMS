...
export class SubjectHomeworkComponent implements OnInit {
  ...
  openEntry = function (result: SubjectHomeworkModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(SubjectHomeworkEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
