...
export class GroupStudentComponent implements OnInit {
  ...
  openEntry = function (result: GroupStudentModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(GroupStudentEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
