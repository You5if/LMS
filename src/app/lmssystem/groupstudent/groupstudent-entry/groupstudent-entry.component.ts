...
import { GroupStudentEntryService } from './groupstudent-entry.service';

@Component({
  selector: 'app-groupstudent-entry',
  templateUrl: './groupstudent-entry.component.html',
  styleUrls: ['./groupstudent-entry.component.scss']
})

export class GroupStudentEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: GroupStudentEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<GroupStudentEntryComponent>,
