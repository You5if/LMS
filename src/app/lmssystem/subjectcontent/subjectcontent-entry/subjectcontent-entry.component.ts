...
import { SubjectContentEntryService } from './subjectcontent-entry.service';

@Component({
  selector: 'app-subjectcontent-entry',
  templateUrl: './subjectcontent-entry.component.html',
  styleUrls: ['./subjectcontent-entry.component.scss']
})

export class SubjectContentEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubjectContentEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubjectContentEntryComponent>,
