...
import { HomeworkSubEntryService } from './homeworksub-entry.service';

@Component({
  selector: 'app-homeworksub-entry',
  templateUrl: './homeworksub-entry.component.html',
  styleUrls: ['./homeworksub-entry.component.scss']
})

export class HomeworkSubEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: HomeworkSubEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<HomeworkSubEntryComponent>,
