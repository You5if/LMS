...
import { VehicleDriverEntryService } from './vehicledriver-entry.service';

@Component({
  selector: 'app-vehicledriver-entry',
  templateUrl: './vehicledriver-entry.component.html',
  styleUrls: ['./vehicledriver-entry.component.scss']
})

export class VehicleDriverEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: VehicleDriverEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<VehicleDriverEntryComponent>,
