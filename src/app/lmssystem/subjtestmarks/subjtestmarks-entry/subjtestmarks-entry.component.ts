...
import { SubjTestMarksEntryService } from './subjtestmarks-entry.service';

@Component({
  selector: 'app-subjtestmarks-entry',
  templateUrl: './subjtestmarks-entry.component.html',
  styleUrls: ['./subjtestmarks-entry.component.scss']
})

export class SubjTestMarksEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubjTestMarksEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubjTestMarksEntryComponent>,
