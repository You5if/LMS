...
import { QuBanFillEntryService } from './qubanfill-entry.service';

@Component({
  selector: 'app-qubanfill-entry',
  templateUrl: './qubanfill-entry.component.html',
  styleUrls: ['./qubanfill-entry.component.scss']
})

export class QuBanFillEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: QuBanFillEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<QuBanFillEntryComponent>,
