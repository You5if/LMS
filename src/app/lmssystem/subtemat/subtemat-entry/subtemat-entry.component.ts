...
import { SubTeMatEntryService } from './subtemat-entry.service';

@Component({
  selector: 'app-subtemat-entry',
  templateUrl: './subtemat-entry.component.html',
  styleUrls: ['./subtemat-entry.component.scss']
})

export class SubTeMatEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubTeMatEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubTeMatEntryComponent>,
