...
import { SchoolClassEntryService } from './schoolclass-entry.service';

@Component({
  selector: 'app-schoolclass-entry',
  templateUrl: './schoolclass-entry.component.html',
  styleUrls: ['./schoolclass-entry.component.scss']
})

export class SchoolClassEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SchoolClassEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SchoolClassEntryComponent>,
