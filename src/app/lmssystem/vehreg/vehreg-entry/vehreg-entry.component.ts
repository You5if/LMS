...
import { VehRegEntryService } from './vehreg-entry.service';

@Component({
  selector: 'app-vehreg-entry',
  templateUrl: './vehreg-entry.component.html',
  styleUrls: ['./vehreg-entry.component.scss']
})

export class VehRegEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: VehRegEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<VehRegEntryComponent>,
