...
import { StudentAttendEntryService } from './studentattend-entry.service';

@Component({
  selector: 'app-studentattend-entry',
  templateUrl: './studentattend-entry.component.html',
  styleUrls: ['./studentattend-entry.component.scss']
})

export class StudentAttendEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: StudentAttendEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<StudentAttendEntryComponent>,
  ...
  onSubmit() {
    ...
    for(let i=0;i<=this.data.length;i++){
     ...
     console.log("attendarray", JSON.stringify(this.last));
