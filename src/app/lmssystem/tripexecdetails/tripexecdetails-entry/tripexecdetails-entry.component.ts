...
import { TripExecDetailsEntryService } from './tripexecdetails-entry.service';

@Component({
  selector: 'app-tripexecdetails-entry',
  templateUrl: './tripexecdetails-entry.component.html',
  styleUrls: ['./tripexecdetails-entry.component.scss']
})

export class TripExecDetailsEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: TripExecDetailsEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<TripExecDetailsEntryComponent>,
