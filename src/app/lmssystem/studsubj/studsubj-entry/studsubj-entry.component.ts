...
import { StudSubjEntryService } from './studsubj-entry.service';

@Component({
  selector: 'app-studsubj-entry',
  templateUrl: './studsubj-entry.component.html',
  styleUrls: ['./studsubj-entry.component.scss']
})

export class StudSubjEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: StudSubjEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<StudSubjEntryComponent>,
