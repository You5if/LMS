...
export class QuestionBankComponent implements OnInit {
  ...
  openEntry = function (result: QuestionBankModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(QuestionBankEntryComponent,{
        disableClose: true,
        data: {}
      });
    } else {
