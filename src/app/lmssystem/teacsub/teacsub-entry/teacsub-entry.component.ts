...
import { TeacSubEntryService } from './teacsub-entry.service';

@Component({
  selector: 'app-teacsub-entry',
  templateUrl: './teacsub-entry.component.html',
  styleUrls: ['./teacsub-entry.component.scss']
})

export class TeacSubEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: TeacSubEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<TeacSubEntryComponent>,
  ...
  onSubmit() {
    ...
    for(let i=0;i<=this.data.length;i++){
     ...
     console.log("teacsubarray", JSON.stringify(this.last));
