...
import { SubjTestEntryService } from './subjtest-entry.service';

@Component({
  selector: 'app-subjtest-entry',
  templateUrl: './subjtest-entry.component.html',
  styleUrls: ['./subjtest-entry.component.scss']
})

export class SubjTestEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubjTestEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubjTestEntryComponent>,
