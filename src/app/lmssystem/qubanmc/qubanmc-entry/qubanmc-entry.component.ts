...
import { QuBanMCEntryService } from './qubanmc-entry.service';

@Component({
  selector: 'app-qubanmc-entry',
  templateUrl: './qubanmc-entry.component.html',
  styleUrls: ['./qubanmc-entry.component.scss']
})

export class QuBanMCEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: QuBanMCEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<QuBanMCEntryComponent>,
