...
import { SchoolgroupEntryService } from './schoolgroup-entry.service';

@Component({
  selector: 'app-schoolgroup-entry',
  templateUrl: './schoolgroup-entry.component.html',
  styleUrls: ['./schoolgroup-entry.component.scss']
})

export class SchoolgroupEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SchoolgroupEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SchoolgroupEntryComponent>,
