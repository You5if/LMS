...
import { QuBanMatEntryService } from './qubanmat-entry.service';

@Component({
  selector: 'app-qubanmat-entry',
  templateUrl: './qubanmat-entry.component.html',
  styleUrls: ['./qubanmat-entry.component.scss']
})

export class QuBanMatEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: QuBanMatEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<QuBanMatEntryComponent>,
