...
import { QuBanOrdEntryService } from './qubanord-entry.service';

@Component({
  selector: 'app-qubanord-entry',
  templateUrl: './qubanord-entry.component.html',
  styleUrls: ['./qubanord-entry.component.scss']
})

export class QuBanOrdEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: QuBanOrdEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<QuBanOrdEntryComponent>,
