...
import { TestGradeEntryService } from './testgrade-entry.service';

@Component({
  selector: 'app-testgrade-entry',
  templateUrl: './testgrade-entry.component.html',
  styleUrls: ['./testgrade-entry.component.scss']
})

export class TestGradeEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: TestGradeEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<TestGradeEntryComponent>,
