...
import { SubTeBlankEntryService } from './subteblank-entry.service';

@Component({
  selector: 'app-subteblank-entry',
  templateUrl: './subteblank-entry.component.html',
  styleUrls: ['./subteblank-entry.component.scss']
})

export class SubTeBlankEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubTeBlankEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubTeBlankEntryComponent>,
