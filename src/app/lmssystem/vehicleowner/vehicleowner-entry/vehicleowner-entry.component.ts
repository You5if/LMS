...
import { VehicleOwnerEntryService } from './vehicleowner-entry.service';

@Component({
  selector: 'app-vehicleowner-entry',
  templateUrl: './vehicleowner-entry.component.html',
  styleUrls: ['./vehicleowner-entry.component.scss']
})

export class VehicleOwnerEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: VehicleOwnerEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<VehicleOwnerEntryComponent>,
