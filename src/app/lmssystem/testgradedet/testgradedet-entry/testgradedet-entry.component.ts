...
import { TestGradeDetEntryService } from './testgradedet-entry.service';

@Component({
  selector: 'app-testgradedet-entry',
  templateUrl: './testgradedet-entry.component.html',
  styleUrls: ['./testgradedet-entry.component.scss']
})

export class TestGradeDetEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: TestGradeDetEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<TestGradeDetEntryComponent>,
