...
import { TripShiftDetailsEntryService } from './tripshiftdetails-entry.service';

@Component({
  selector: 'app-tripshiftdetails-entry',
  templateUrl: './tripshiftdetails-entry.component.html',
  styleUrls: ['./tripshiftdetails-entry.component.scss']
})

export class TripShiftDetailsEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: TripShiftDetailsEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<TripShiftDetailsEntryComponent>,
