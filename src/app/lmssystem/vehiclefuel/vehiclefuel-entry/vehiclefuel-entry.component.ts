...
import { VehicleFuelEntryService } from './vehiclefuel-entry.service';

@Component({
  selector: 'app-vehiclefuel-entry',
  templateUrl: './vehiclefuel-entry.component.html',
  styleUrls: ['./vehiclefuel-entry.component.scss']
})

export class VehicleFuelEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: VehicleFuelEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<VehicleFuelEntryComponent>,
