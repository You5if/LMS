...
import { VehicleMileageEntryService } from './vehiclemileage-entry.service';

@Component({
  selector: 'app-vehiclemileage-entry',
  templateUrl: './vehiclemileage-entry.component.html',
  styleUrls: ['./vehiclemileage-entry.component.scss']
})

export class VehicleMileageEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: VehicleMileageEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<VehicleMileageEntryComponent>,
