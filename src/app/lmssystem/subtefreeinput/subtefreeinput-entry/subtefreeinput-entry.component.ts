...
import { SubTeFreeInputEntryService } from './subtefreeinput-entry.service';

@Component({
  selector: 'app-subtefreeinput-entry',
  templateUrl: './subtefreeinput-entry.component.html',
  styleUrls: ['./subtefreeinput-entry.component.scss']
})

export class SubTeFreeInputEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubTeFreeInputEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubTeFreeInputEntryComponent>,
