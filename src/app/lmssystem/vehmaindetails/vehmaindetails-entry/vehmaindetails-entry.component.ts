...
import { VehMainDetailsEntryService } from './vehmaindetails-entry.service';

@Component({
  selector: 'app-vehmaindetails-entry',
  templateUrl: './vehmaindetails-entry.component.html',
  styleUrls: ['./vehmaindetails-entry.component.scss']
})

export class VehMainDetailsEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: VehMainDetailsEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<VehMainDetailsEntryComponent>,
