...
import { SubTeQueEntryService } from './subteque-entry.service';

@Component({
  selector: 'app-subteque-entry',
  templateUrl: './subteque-entry.component.html',
  styleUrls: ['./subteque-entry.component.scss']
})

export class SubTeQueEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubTeQueEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubTeQueEntryComponent>,
