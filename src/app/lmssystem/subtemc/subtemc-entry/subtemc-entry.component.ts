...
import { SubTeMCEntryService } from './subtemc-entry.service';

@Component({
  selector: 'app-subtemc-entry',
  templateUrl: './subtemc-entry.component.html',
  styleUrls: ['./subtemc-entry.component.scss']
})

export class SubTeMCEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubTeMCEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubTeMCEntryComponent>,
