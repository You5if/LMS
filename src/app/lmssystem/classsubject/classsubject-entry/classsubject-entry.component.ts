...
import { ClassSubjectEntryService } from './classsubject-entry.service';

@Component({
  selector: 'app-classsubject-entry',
  templateUrl: './classsubject-entry.component.html',
  styleUrls: ['./classsubject-entry.component.scss']
})

export class ClassSubjectEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: ClassSubjectEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<ClassSubjectEntryComponent>,
