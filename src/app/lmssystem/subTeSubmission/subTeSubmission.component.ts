...
export class SubTeSubmissionComponent implements OnInit {
  ...
  openEntry = function (result: SubTeSubmissionModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(subTeSubmissionEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
