...
import { SubjectTrackingEntryService } from './subjecttracking-entry.service';

@Component({
  selector: 'app-subjecttracking-entry',
  templateUrl: './subjecttracking-entry.component.html',
  styleUrls: ['./subjecttracking-entry.component.scss']
})

export class SubjectTrackingEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SubjectTrackingEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SubjectTrackingEntryComponent>,
