...
import { SchoolYearEntryService } from './schoolyear-entry.service';

@Component({
  selector: 'app-schoolyear-entry',
  templateUrl: './schoolyear-entry.component.html',
  styleUrls: ['./schoolyear-entry.component.scss']
})

export class SchoolYearEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: SchoolYearEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<SchoolYearEntryComponent>,
