...
import { VehMainEntryService } from './vehmain-entry.service';

@Component({
  selector: 'app-vehmain-entry',
  templateUrl: './vehmain-entry.component.html',
  styleUrls: ['./vehmain-entry.component.scss']
})

export class VehMainEntryComponent implements OnInit {
  ...
  constructor(
	  private dapiService: VehMainEntryService,
      private _ui: UIService,
      private _msg: MessageBoxService,
      private _auth: AuthService,
      private _globals: AppGlobals,
      private _select: SelectService,
      private dialogRef: MatDialogRef<VehMainEntryComponent>,
