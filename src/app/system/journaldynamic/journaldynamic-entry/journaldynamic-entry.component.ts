...
import { JournalDynamicService } from './journaldynamin-entry.service';

@Component({
  selector: 'app-journaldynamic-entry',
  templateUrl: './journaldynamic-entry.component.html',
  styleUrls: ['./journaldynamic-entry.component.scss']
})
export class JournaldynamicEntryComponent implements OnInit {
...
// expenseFilingItemDataSource = new MatTableDataSource(this.expenseFilingItemData);
  ...
  constructor( private dapiService: JournalDynamicService,
     private _ui: UIService,
      private _globals: AppGlobals,
      private _msg: MessageBoxService,
      private _select: SelectService,
      private dialogRef: MatDialogRef<JournaldynamicEntryComponent>,
  ...
  ngOnInit(): void {
    ...
    this.dapiService.Controllers(this.pModel).subscribe(res => {
      ...
      if(this.data.length > 0) {
        ...
        this.dapiService.getItem1byId(+this.data[0].value).subscribe((res) => {
        ...
        // this.dapiService.getItem2byId(+this.data[0].value).subscribe((res) => {
  ...
  addChild1ExpenseItem(id:number) {
    ...
    this.dapiService.Item1Controllers(this.model2).subscribe((res) => {
  ...
  //     languageId: +localStorage.getItem(this._globals.baseAppName + '_language')
  //   };
  //   this.dapiService.Item2Controllers(this.model3).subscribe((res) => {
