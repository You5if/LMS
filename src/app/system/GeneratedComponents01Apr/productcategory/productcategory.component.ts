...
export class ProductCategoryComponent implements OnInit {
  ...
  openEntry = function (result: ProductCategoryModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(ProductCategoryEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
