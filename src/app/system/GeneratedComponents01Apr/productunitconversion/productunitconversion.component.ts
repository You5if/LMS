...
export class ProductUnitConversionComponent implements OnInit {
  ...
  indexes: ProductUnitConversionModel;
  ...
  refreshMe() {
    if(localStorage.getItem(this._globals.baseAppName + '_language') == "16001") {
      this.direction = "ltr"
      this.header = "Service unit conversion"
      ...
      this.direction = "rtl"
      this.header = "تحويلات وحدات الخدمات"
    ...
    try {
      this._cf.getPageDataOnPaginatorOperation(event, this.pTableName, this.pScreenId, this._auth.getUserId(),
        this.pTableId, this.totalRecords).subscribe(
          (result: ProductUnitConversionModel) => {
  ...
  openEntry = function (result: ProductUnitConversionModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(ProductUnitConversionEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
