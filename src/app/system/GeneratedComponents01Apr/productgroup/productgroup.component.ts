...
export class ProductGroupComponent implements OnInit {
  ...
  openEntry = function (result: ProductGroupModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(ProductGroupEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
