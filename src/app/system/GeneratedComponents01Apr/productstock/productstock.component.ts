...
export class ProductStockComponent implements OnInit {
  ...
  openEntry = function (result: ProductStockModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(ProductStockEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
