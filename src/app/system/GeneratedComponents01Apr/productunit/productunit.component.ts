...
export class ProductUnitComponent implements OnInit {
  ...
  openEntry = function (result: ProductUnitModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(ProductUnitEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
