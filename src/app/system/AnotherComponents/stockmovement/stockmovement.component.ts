...
export class StockMovementComponent implements OnInit {
  ...
  openEntry = function (result: StockMovementModel) {
    if (result === undefined) {
      this.dialogRef = this.dialog.open(StockMovementEntryComponent, {
        disableClose: true,
        data: {}
      });
    } else {
