...
export class TaxService {
   ...
   getTaxEntry(id: number): Observable<TaxModel> {
      return this.httpClient.get<TaxModel>(this._globals.baseAPIUrl + 'Tax/' + id).pipe(
      map((result: TaxModel) => {
      return result;
   ...
   getTaxSubmit(data: TaxModel) {
      ...
      switch (data.entryMode) {
          ...
          case 'A': {
          return this.http.post(this._globals.baseAPIUrl + 'Tax/create', data, this._cf.requestOptions()).pipe(
          ...
          case 'E': {
          return this.http.post(this._globals.baseAPIUrl + 'Tax/edit', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
          ...
          case 'D': {
          return this.http.post(this._globals.baseAPIUrl + 'Tax/delete', data, this._cf.requestOptions()).pipe(
          map((response: Response) => {
          return response.json();
          }), catchError(this._cf.handleError));
          }
